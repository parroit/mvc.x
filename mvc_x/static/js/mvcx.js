...
function show(href,modal_id) {




    var form=$("#"+modal_id) //.clone(true,true)
...
function submit_form(form_name) {
    ...
    $("#info-box").addClass("alert");
    $("#info-title").html("Wait");
    $("#info-icon").attr("src","/img/saving.png");
    $("#info-text").html("Saving data...");
